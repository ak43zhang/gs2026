...
class FilterConfig:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'FilterConfig':
        ...
        return cls(
            ...
            bond_change_min=_float('bond_change_min'),
            ...
            bond_change_min_mode=_mode('bond_change_min_mode'),
