...
if __name__ == "__main__":
    ...
    try:
        ...
        # deepseek_pool.add_account('ZblblcWuwaws752136@outlook.com', '2026#8868#')
        # deepseek_pool.add_account('DboutvWwwoyz69500@outlook.com', '2026#8868#')
        # deepseek_pool.add_account('WsitmOvdmj9084@outlook.com', '2026#8868#')
        ...
        deepseek_pool.add_account('JasonYorkhggw@outlook.com', 'JasonYorkhggw@outlook.com')
        deepseek_pool.add_account('ErinKelly2421ah@outlook.com', 'ErinKelly2421ah@outlook.com')
        deepseek_pool.add_account('CarolDonovanmws@outlook.com', 'CarolDonovanmws@outlook.com')
        deepseek_pool.add_account('JustinBush6933j4Jv@outlook.com', 'JustinBush6933j4Jv@outlook.com')
        deepseek_pool.add_account('HaleyPrestonsg@outlook.com', 'HaleyPrestonsg@outlook.com')
        deepseek_pool.add_account('AmySpencer1694@outlook.com', 'AmySpencer1694@outlook.com')
        deepseek_pool.add_account('HeatherGraham2167@outlook.com', 'HeatherGraham2167@outlook.com')
        deepseek_pool.add_account('WilliamDean9062h6Iw@outlook.com', 'WilliamDean9062h6Iw@outlook.com')
        deepseek_pool.add_account('MargaretHoover8100@outlook.com', 'MargaretHoover8100@outlook.com')
        deepseek_pool.add_account('LarryWhiteoguu@outlook.com', 'LarryWhiteoguu@outlook.com')
        deepseek_pool.add_account('RachelShawbu@outlook.com', 'RachelShawbu@outlook.com')
        deepseek_pool.add_account('AlexandraSparks6159@outlook.com', 'AlexandraSparks6159@outlook.com')
        deepseek_pool.add_account('AmandaAlvarezubb@outlook.com', 'AmandaAlvarezubb@outlook.com')
        deepseek_pool.add_account('PaulaBell1596@outlook.com', 'PaulaBell1596@outlook.com')
        deepseek_pool.add_account('WendyHamptonoav@outlook.com', 'WendyHamptonoav@outlook.com')
        deepseek_pool.add_account('TanyaLogan4835@outlook.com', 'TanyaLogan4835@outlook.com')
        deepseek_pool.add_account('ArthurEvans670156@outlook.com', 'ArthurEvans670156@outlook.com')
        deepseek_pool.add_account('JanetJones45735qrK@outlook.com', 'JanetJones45735qrK@outlook.com')
        deepseek_pool.add_account('DonaldThompson6338@outlook.com', 'DonaldThompson6338@outlook.com')
        deepseek_pool.add_account('LisaBrooks825489B@outlook.com', 'LisaBrooks825489B@outlook.com')
        deepseek_pool.add_account('LindaColeman5077@outlook.com', 'LindaColeman5077@outlook.com')
        deepseek_pool.add_account('AlanTucker8346@outlook.com', 'AlanTucker8346@outlook.com')
        deepseek_pool.add_account('MatthewValenciagqho@outlook.com', 'MatthewValenciagqho@outlook.com')
        deepseek_pool.add_account('MichelleCruzqra@outlook.com', 'MichelleCruzqra@outlook.com')
        deepseek_pool.add_account('MeganKnight6000Jkd@outlook.com', 'MeganKnight6000Jkd@outlook.com')
        deepseek_pool.add_account('DominiqueForbespbq@outlook.com', 'DominiqueForbespbq@outlook.com')
        deepseek_pool.add_account('SandraAndrews20234G@outlook.com', 'SandraAndrews20234G@outlook.com')
        deepseek_pool.add_account('WilliamCampbellgk@outlook.com', 'WilliamCampbellgk@outlook.com')
        deepseek_pool.add_account('AlexanderBailey3330MZzv@outlook.com', 'AlexanderBailey3330MZzv@outlook.com')
        deepseek_pool.add_account('LaurenSerrano3029@outlook.com', 'LaurenSerrano3029@outlook.com')
