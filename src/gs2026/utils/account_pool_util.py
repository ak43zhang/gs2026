...
if __name__ == "__main__":
    ...
    try:
        ...
        deepseek_pool.add_account('brianhill3199@outlook.com', 'qilr6971')
        deepseek_pool.add_account('jennifermyers2581@outlook.com', 'umsnvggl53627')
        deepseek_pool.add_account('jefferysanchez9092@outlook.com', 'tlna2956372')
        deepseek_pool.add_account('amandamcdaniel9990@outlook.com', 'asvmyv8078')
        deepseek_pool.add_account('dawnwilson3602@outlook.com', 'jfxyumv2250')
        deepseek_pool.add_account('josephbarnes8736@outlook.com', 'gedej824203')
        deepseek_pool.add_account('dominiquewatts5013@outlook.com', 'jkwu5658')
        deepseek_pool.add_account('sarahfletcher9168@outlook.com', 'quekfpxy379968')
        deepseek_pool.add_account('nicolerichardson8811@outlook.com', 'tvkztaey181522')
        deepseek_pool.add_account('thomascardenas3832@outlook.com', 'jkqezg6635')
        deepseek_pool.add_account('juandavis6915@outlook.com', 'xcqn88522')
        deepseek_pool.add_account('staceygeorge7936@outlook.com', 'omeq7467690')
        deepseek_pool.add_account('melanieherring5806@outlook.com', 'dngnizo1994')
        deepseek_pool.add_account('larrylewis5183@outlook.com', 'nuxgf48887')
        deepseek_pool.add_account('frankkent9656@outlook.com', 'lllfry5808228')
        deepseek_pool.add_account('laurenmedina7633@outlook.com', 'svdvnhu2598')
        deepseek_pool.add_account('juliawhite1700@outlook.com', 'qaqktdk590544')
        deepseek_pool.add_account('tayloresparza1009@outlook.com', 'pjrplf816898')
        deepseek_pool.add_account('cristinaford1898@outlook.com', 'diwt47983')
        deepseek_pool.add_account('jennyperry9607@outlook.com', 'cgzhsyh144522')
        deepseek_pool.add_account('josephsmith2289@outlook.com', 'xcsxgx406202')
        deepseek_pool.add_account('amyharvey1592@outlook.com', 'fynpayyt610946')
        deepseek_pool.add_account('thomasvaldez2979@outlook.com', 'vzbelqoa79630')
        deepseek_pool.add_account('peggygarcia3473@outlook.com', 'txsz9944')
        deepseek_pool.add_account('haileymason9736@outlook.com', 'hjruip4300426')
        deepseek_pool.add_account('crystaldominguez3605@outlook.com', 'qbnveil9926950')
        deepseek_pool.add_account('christopherwinters7357@outlook.com', 'xuunwzgo13281')
        deepseek_pool.add_account('brittanydavis5629@outlook.com', 'hmfkcp360481')
        deepseek_pool.add_account('kristinepierce7238@outlook.com', 'xoldyquw158565')
        deepseek_pool.add_account('markcompton8257@outlook.com', 'bdxbnin6116795')
