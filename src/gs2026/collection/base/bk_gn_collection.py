...
if __name__ == "__main__":
    ...
    start_time = config_util.get_config("exe.history.bk_gn_collection.start_time", "2026-04-02")
    end_time = config_util.get_config("exe.history.bk_gn_collection.end_time", "2026-04-02")
