...
try:
    from src.gs2026.collection.base.bk_gn_collection import bk_gn_collect
    log("[RUN] 调用 " + FUNCTION_NAME)
    bk_gn_collect(start_date='2026-03-26', end_date='2026-03-26')
    log("[EXIT] 正常退出")
