...
SERVICE_ID = "wencai_risk_daily"
FUNCTION_NAME = "wencai_risk_collect"
...
try:
    from src.gs2026.collection.risk.wencai_risk_history import wencai_risk_collect
    log("[RUN] 调用 " + FUNCTION_NAME)
    wencai_risk_collect(start_date='2026-04-13', end_date='2026-04-13')
    log("[EXIT] 正常退出")
