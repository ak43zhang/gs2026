...
SERVICE_ID = "ztb"
FUNCTION_NAME = "collect_ztb_query"
...
try:
    from src.gs2026.collection.base.zt_collection import collect_ztb_query
    log("[RUN] 调用 " + FUNCTION_NAME)
    collect_ztb_query(start_date='2026-03-27', end_date='2026-03-27')
    log("[EXIT] 正常退出")
